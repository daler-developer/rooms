import { eq, like, notInArray, count, sql, inArray } from "drizzle-orm";
...
class PgUserRepository implements UserRepository {
  async addOne(dto: AddUserDto): Promise<number> {
  ...
  async updateOneById(userId: number, data: Partial<Exclude<User, "id">>) {
