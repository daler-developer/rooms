...
export type GetRoomParticipantsQuery = { __typename?: 'Query', room: { __typename?: 'Room', id: number, participants: Array<{ __typename?: 'User', id: number, firstName: string, lastName: string, profilePictureUrl?: string | null, isOnline: boolean }> } };
