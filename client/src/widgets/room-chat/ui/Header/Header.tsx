...
import { GET_ME, GET_ROOM, USER_TYPING_STATUS_CHANGED_SUB } from "@/widgets/room-chat/gql/tags.ts";
...
import PendingInvitations from "@/widgets/room-chat/ui/Header/PendingInvitations.tsx";
import RoomInfoModal, { type RoomInfoModalHandler } from "@/widgets/room-chat/ui/RoomInfo/RoomInfoModal.tsx";
import ParticipantsOnlineCount from "@/widgets/room-chat/ui/Header/ParticipantsOnlineCount.tsx";
import SelectedMessagesController from "@/widgets/room-chat/ui/Header/SelectedMessagesController.tsx";
        ...
        left={
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col justify-between">
              ...
              {/*{participantsTypingExceptMe.map((user) => (*/}
